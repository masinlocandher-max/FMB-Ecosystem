(function(){
  ...
  const replyBank={
    ...
    identity:[
      'I am AZ, the female digital Receptionist for the FMB&CO. public website. I answer verified website questions from a premade reply bank.',
  ...
  const screens={
    ...
    find:{title:'Find Something',body:'Of course. I can help you find the right part of With Love, FMB. What would you like to explore?',options:[
      link('About FMB',`${SITE_URL}/aboutfmb/`),link('Latest News',`${SITE_URL}/news/`),link('Reading Library',`${SITE_URL}/ebooks/`),link('Music Library',`${SITE_URL}/music/`),link('Public Help Directory',`${SITE_URL}/gethelp/`),link('Community Engagements',`${SITE_URL}/communityengagements/`),link('Freedom Wall',`${SITE_URL}/freedom-wall.html`),link('FMB&CO.',`${SITE_URL}/fmb&co/`),link('Work with FMB&CO.',`${SITE_URL}/aboutfmb/#work-with-fmb`),contact('Contact the Team','General Question'),q('Search the Website','search'),q('I Cannot Find a Page','missing'),main
    ]},
    search:{title:'Search the Website',body:'I understand. Enter a keyword below, or choose a category. I will match it with the closest available page.',focusSearch:true,options:[
      link('About FMB',`${SITE_URL}/aboutfmb/`),link('FMB&CO.',`${SITE_URL}/fmb&co/`),link('SENZ',`${SITE_URL}/fmb&co/senz/`),link('Cognita',`${SITE_URL}/fmb&co/cognita/`),link('News',`${SITE_URL}/news/`),link('Reading',`${SITE_URL}/ebooks/`),link('Music',`${SITE_URL}/music/`),link('Community Engagements',`${SITE_URL}/communityengagements/`),link('Freedom Wall',`${SITE_URL}/freedom-wall.html`),link('Public Help Directory',`${SITE_URL}/gethelp/`),link('Professional Services',`${SITE_URL}/aboutfmb/#work-with-fmb`),back,main
    ]},
    ...
    media:{title:'News and Publications',body:'I can help you open the public news, reading, music, and community pages published on the website.',options:[
      link('Latest News',`${SITE_URL}/news/`),link('Reading Library',`${SITE_URL}/ebooks/`),link('Music Library',`${SITE_URL}/music/`),link('Freedom Wall',`${SITE_URL}/freedom-wall.html`),link('Community Engagements',`${SITE_URL}/communityengagements/`),q('Can I Share Published Content?','share_content'),q('Content Credits','credits'),main
    ]},
    ...
    payments:{title:'Services, Fees, and Partnerships',body:'A specific professional service, product, event, or program may have a clearly published fee. FMB&CO. does not accept donations.',options:[
      q('Donation Policy','donations'),q('Professional Services','work'),q('Business Partnerships','partnerships'),contact('Verify a Published Fee','General Question'),contact('Request a Service Receipt','General Question'),contact('Service Refund or Cancellation','General Question'),q('Report a Suspicious Request','suspicious'),main
    ]},
  ...
  const searchIndex=[
    ...
    {words:'yoni orange bear mental health companion friend inside app mascot',screen:'app_boundary',priority:95},
