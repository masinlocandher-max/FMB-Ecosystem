(function(){
'use strict';
const version='20260721-native-libraries-v2';
...
(async()=>{
  await load('/assets/js/yoni-reply-core.js');
  await load('/assets/js/yoni-human-taglish.js');
  await load('/assets/js/yoni-visual-final.js');
