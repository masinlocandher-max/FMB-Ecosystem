...
const stylesheet = '/assets/css/fmbnews-clean-v1.css?v=20260807-production-v2';
...
function shell(titles = [], active = 'latest') {
  ...
  const links = [
    ...
    ['About FMB News', '/news/about/', 'about'],
    ['Editorial standards', '/news/about/#standards', 'standards'],
