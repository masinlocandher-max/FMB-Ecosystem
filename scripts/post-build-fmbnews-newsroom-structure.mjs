...
const latest = latestPage(normal,morning);
...
const aliasLanding = latest.replace('content="index,follow,max-image-preview:large"', 'content="noindex,follow,max-image-preview:large"');
await writeFile(path.join(aliasDir,'index.html'), aliasLanding, 'utf8');
