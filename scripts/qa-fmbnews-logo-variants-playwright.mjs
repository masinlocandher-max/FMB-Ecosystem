...
function watchConsole(page,label){
  page.on('console',message=>{if(message.type()==='error'||message.type()==='warning')results.console.push({page:label,type:message.type(),text:message.text()})});
...
try{
  ...
  requireCheck('desktop uses clean newsroom shell',landing.clean&&landing.headerCount===1&&landing.footerCount===1,landing);
  ...
  await screenshot(desktop,'fmbnews-clean-desktop-first-view.png');
  ...
  await footerLogo.screenshot({path:path.join(evidenceDir,'fmbnews-clean-desktop-footer.png')});
  results.screenshots.push('fmbnews-clean-desktop-footer.png');
  ...
  await screenshot(mobile,'fmbnews-clean-mobile-first-view.png');
  ...
  await screenshot(mobile,'fmbnews-clean-mobile-menu.png');
  ...
  await mobile.locator('[data-fmb-news-logo-dark]').screenshot({path:path.join(evidenceDir,'fmbnews-clean-mobile-footer.png')});
  results.screenshots.push('fmbnews-clean-mobile-footer.png');
  ...
  await screenshot(article,'fmbnews-clean-mobile-article-first-view.png');
  ...
  await sharePanel.screenshot({path:path.join(evidenceDir,'fmbnews-clean-mobile-article-share.png')});
  results.screenshots.push('fmbnews-clean-mobile-article-share.png');
...
console.log(`FMB News clean supplied-logo browser QA passed with ${Object.keys(results.checks).length} checks.`);
