...
try{
  ...
  requireCheck('desktop uses one approved-v3 clean newsroom shell',landing.clean&&landing.headerCount===1&&landing.footerCount===1&&landing.livebarCount===1,landing);
  ...
  await screenshot(desktop,'fmbnews-approved-v3-desktop-first-view.png');
  ...
  await footerLogo.screenshot({path:path.join(evidenceDir,'fmbnews-approved-v3-desktop-footer.png')});results.screenshots.push('fmbnews-approved-v3-desktop-footer.png');
  ...
  await screenshot(mobile,'fmbnews-approved-v3-mobile-first-view.png');
  ...
  await screenshot(mobile,'fmbnews-approved-v3-mobile-menu.png');
  ...
  await mobile.locator('[data-fmb-news-logo-dark]').screenshot({path:path.join(evidenceDir,'fmbnews-approved-v3-mobile-footer.png')});results.screenshots.push('fmbnews-approved-v3-mobile-footer.png');
  ...
  await screenshot(article,'fmbnews-approved-v3-mobile-article-first-view.png');
  ...
  await sharePanel.screenshot({path:path.join(evidenceDir,'fmbnews-approved-v3-mobile-article-share.png')});results.screenshots.push('fmbnews-approved-v3-mobile-article-share.png');
...
console.log(`FMB News approved-v3 supplied-logo browser QA passed with ${Object.keys(results.checks).length} checks.`);
