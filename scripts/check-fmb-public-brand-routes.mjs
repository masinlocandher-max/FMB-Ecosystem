...
if (!masthead.includes(suppliedColorNewsLogo)) warn('news/index.html is missing the exact supplied color masthead logo');
if (!footer.includes(suppliedWhiteNewsLogo)) warn('news/index.html is missing the exact supplied white footer logo');
