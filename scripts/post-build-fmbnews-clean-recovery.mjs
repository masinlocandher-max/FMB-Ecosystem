...
await writeFile(path.join(fmb,'index.html'),landingPage(records),'utf8');
await mkdir(path.join(fmb,'about'),{recursive:true});
await writeFile(path.join(fmb,'about','index.html'),aboutPage(),'utf8');
await writeFile(path.join(news,'index.html'),redirectPage('/fmbnews/'),'utf8');
