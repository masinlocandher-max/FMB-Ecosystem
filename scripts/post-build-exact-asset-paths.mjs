...
const newsLogo='/assets/images/news/fmb-news-official.svg';
const musicLogo='/assets/images/channels/fmb-music-official.svg';
const ebookLogo='/assets/images/channels/fmb-ebook-official.svg';
const globalReplacements=new Map([
  ...
  [`${approved}/fmb-news-official-transparent.webp`,newsLogo],
  [`${approved}/fmb-music-official-transparent.webp`,musicLogo],
  [`${approved}/fmb-ebook-official-transparent.webp`,ebookLogo],
  ['/assets/images/fmb-official-2026/fmb-master-square.webp',`${approved}/fmb-master-purple-square.webp`],
  ['/assets/images/fmb-official-2026/fmb-news-official.webp',newsLogo],
  ['/assets/images/fmb-official-2026/fmb-music-official.webp',musicLogo]
]);
const priorityAssetByPage={
  ...
  'news/index.html':newsLogo,
  'music/index.html':musicLogo,
  'ebooks/index.html':ebookLogo,
...
body.fmb-identity-v3 :is(.nc-brand-mark,.nc-publication-brand,.nc-channel-lockup) img{width:min(100%,940px)!important;height:auto!important;max-height:212px!important;object-fit:contain!important;object-position:left center!important;background:transparent!important;filter:none!important;transform:none!important}
...
console.log(`Purged retired identities, delivered browser-safe channel lockups, assigned one intentional priority image, and applied exact responsive portrait composition across ${pages.length} rendered pages.`);
