...
const pages=['index.html','aboutfmb/index.html','withlovefmb/index.html','communityengagements/index.html','gethelp/index.html','news/index.html','fmbandco/index.html','fmbandco/senz/index.html','fmbandco/cognita/index.html','app/install/index.html'];
const errors=[];
const results=[];
