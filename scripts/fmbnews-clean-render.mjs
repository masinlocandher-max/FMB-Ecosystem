...
const css = '/assets/css/fmbnews-clean-v1.css?v=20260808-newsdesk-v5';
...
export function head(title, description, canonical, image = logo, type = 'website', publishedAt = '') {
