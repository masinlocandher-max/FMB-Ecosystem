...
const pages={
  'index.html':[asset('masterTransparent'),asset('standingLandscape'),asset('seatedLandscape'),'Official Digital Headquarters','Yoni App 2.0','Mabayani','/assets/js/az-assistant.js'],
  'aboutfmb/index.html':[asset('standingLandscape'),asset('seatedLandscape'),asset('portraitFront'),'data-fmb-signature="about"'],
  'withlovefmb/index.html':[asset('seatedLandscape'),asset('portraitAngleRight'),'data-fmb-signature="withlove"','/assets/images/volunteer/francine-leading-with-love-fmb.webp','/assets/images/volunteer/francine-serving-with-volunteers.webp'],
  'news/index.html':[asset('news'),asset('portraitFront'),'data-fmb-signature="news"'],
  'music/index.html':[asset('music'),asset('portraitAngleLeft'),'data-fmb-signature="music"','id="audioPlayer"'],
  'ebooks/index.html':[asset('ebook'),asset('portraitAngleRight'),'data-fmb-signature="ebook"','data-ebook-filter="open"'],
  'fmb&co/index.html':[asset('standingLandscape'),asset('portraitFront'),'data-fmb-signature="fmbandco"'],
  'fmb&co/senz/index.html':[asset('portraitAngleLeft'),'data-fmb-signature="senz"'],
  'fmb&co/cognita/index.html':[asset('portraitAngleRight'),'data-fmb-signature="cognita"']
};
...
for(const marker of ['object-fit:contain!important','filter:none!important','transform:none!important'])if(!css.includes(marker))fail(`portrait protection is missing ${marker}`);
